...
namespace GMap.NET.MapProviders
{
    ...
    public class GMapProviders
    {
      ...
      public static readonly OpenStreetMapSurferTerrainProvider OpenStreetMapSurferTerrain = OpenStreetMapSurferTerrainProvider.Instance;
        ...
        public static readonly PgisProviderGDDH PgisGDDH = PgisProviderGDDH.Instance;
        public static readonly PgisProviderTDTYX PgisTDTYX = PgisProviderTDTYX.Instance;
        public static readonly PgisProviderPGISSL PgisPGISSL = PgisProviderPGISSL.Instance;
        public static readonly PgisProviderTDTSX PgisTDTSX = PgisProviderTDTSX.Instance;
        public static readonly PgisProviderTDTDM PgisTDTDM = PgisProviderTDTDM.Instance;
        public static readonly PgisProviderTDTJT PgisTDTJT = PgisProviderTDTJT.Instance;
        public static readonly PgisProviderTDTSY PgisTDTSY = PgisProviderTDTSY.Instance;
    ...
    public abstract class GMapProvider
    {
      ...
      public static int TimeoutMs = 44 * 1000; 
        ...
        public string RefererPort = string.Empty;
